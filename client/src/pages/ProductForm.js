...
import { TextField, Button, Autocomplete, createFilterOptions, Chip } from "@mui/material";
        ...
        <form className="Form" onSubmit={handleSubmit}>
            ...
            <Autocomplete
                ...
                onChange={(event, newValue) => {
                    setFormData({ ...formData, categories: newValue.map((value) => Object.assign({ name: value })) })
                }}
                id="categories"
